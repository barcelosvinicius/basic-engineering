...
| **U4** | Paralelismo seguro: *agente paralelo lê; quem escreve é um só* + eixo declarado | 14, 11 | Baixo | aberto |
...
| **U8** | Zero sem denominador: ausência carrega evidência do alvo exercido | 9 | Baixo | aberto |
| **U9** | Gesto de remoção segura (4 eixos + `// NB:`) | 10 | Médio | aberto |
| **U10** | Régua nasce falhando: regra verificável traz caso positivo conhecido | 23 | Médio | parcial |
