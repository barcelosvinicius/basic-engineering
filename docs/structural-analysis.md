...
<!-- generated by scripts/graph-audit.js on 2026-09-23 -->
| Fact | Value |
|------|-------|
...
| Skills citing >= 1 other skill | **24 / 31** |
| Skill leaves (no outgoing edge) | **7 / 31** |
...
| Skills payload (`SKILL.md`, LF bytes) | **155,134 B** |
