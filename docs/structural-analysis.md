...
|---|---|--:|---|
| Skills shipped | `ls plugins/be/skills \| wc -l` | **29** | 2026-08-19 |
| Agents shipped | `ls plugins/be/agents/*.md \| wc -l` | **18** | 2026-08-19 |
...
| Fact | Proof command | Value | Measured on |
|---|---|--:|---|
| Read-only agents (`tools:` restricted) | `grep -l '^tools: Read, Grep, Glob, Bash$' plugins/be/agents/*.md \| wc -l` | **12 / 18** | 2026-08-19 |
| Agents declaring `model:` | `grep -l '^model:' plugins/be/agents/*.md \| wc -l` | **18 / 18** | 2026-08-19 |
| Agents carrying prompt-injection defense | `grep -lie 'prompt.injection\|prompt defense\|untrusted' plugins/be/agents/*.md \| wc -l` | **18 / 18** | 2026-08-19 |
