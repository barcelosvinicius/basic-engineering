...
description: >
  Use at project kickoff, before introducing a new bounded context, or when
  domain boundaries seem to have drifted. DDD-based pipeline: identifies
  bounded contexts, aggregates, domain events, and process flows from code
  structure; output feeds the domain map in docs/structural-analysis.md.
---
...
*See also: the `proc-structural-analysis`, `proc-impact-analysis`, and `proc-sdd` skills.*
