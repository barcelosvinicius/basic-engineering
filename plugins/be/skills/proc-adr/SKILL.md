...
name: proc-adr
description: >
  Use when making any significant technical decision that affects structure,
  security, performance, or is difficult to reverse. Process for recording
  Architectural Decision Records (ADRs) — when to create them, the mandatory
  format, naming, and status lifecycle.
---
...
*Template: `templates/docs/adr-template.md` in the base (instantiate into `docs/adr/`).*
