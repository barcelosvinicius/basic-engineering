...
|-------------------|-------------|
| What the project is | `CLAUDE.md` (or the tool's mirror, e.g. `.github/copilot-instructions.md`) |
| Engineering principles | `engineering-principles.md` in the base |
...
| How to do X in the backend | base skills `be-*` (and project skills) |
| How to do X in the frontend | base skills `fe-*` (and project skills) |
...
*Template — `templates/docs/onboarding.template.md` in the base · Customize for each project*
